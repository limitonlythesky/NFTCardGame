const styles = {
  ...
  // card component
  cardContainer: 'relative sm:w-[200px] w-[160px] sm:h-[275px] h-[220px] z-0 transition-all',
  cardImg: 'w-full h-full object-contain',
  cardPointContainer: 'absolute sm:w-[40px] w-[32px] sm:h-[40px] h-[32px] rounded-[25px] bottom-[20.4%]',
